...
export default function Sidebar() {
  return (
  <div>
    <div id="sidebar" className="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 w-60 mt-1 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
            ...
            <ul className="pb-2 space-y-2">
              <li>
                <a href="/home" className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                  ...
                  <span className="ml-3" sidebar-toggle-item>Home page</span>
                </a>
              </li>
              <li>
                <a href="/createidea" className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                  ...
                  <span className="ml-3" sidebar-toggle-item>Create Idea</span>
                </a>
              </li>
            </ul>
          </div>
